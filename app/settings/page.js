...
export default function Settings() {
  ...
  useEffect(() => {
    ...
    setNavMode(get("vehemence_nav_mode", "top"));
    applyAppearance(loaded);
    document.documentElement.setAttribute("data-nav-mode", get("vehemence_nav_mode", "top"));
  }, []);
  ...
  function toggleNavMode() {
    ...
    setNavMode(next);
    save("vehemence_nav_mode", next);
    document.documentElement.setAttribute("data-nav-mode", next);
    window.dispatchEvent(new Event("vehemence-navigation-changed"));
  }
