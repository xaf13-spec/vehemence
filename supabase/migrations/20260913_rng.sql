...
grant execute on function public.vehemence_rng_favorite(text,text,boolean) to anon, authenticated;
grant execute on function public.vehemence_rng_equip(text,text) to anon, authenticated;
grant execute on function public.vehemence_rng_sacrifice(text,text,integer) to anon, authenticated;
